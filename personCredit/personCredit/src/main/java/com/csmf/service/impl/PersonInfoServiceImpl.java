...
public class PersonInfoServiceImpl implements PersonInfoService {
	...
	public void updateIdentityNum(Map map) throws Exception {
		String identityNum = (String) map.get("identityNum");
		String memberId = (String) map.get("memberId");
		if (!StringUtils.isEmpty(identityNum) && !StringUtils.isEmpty(memberId)) {
			personInfoDao.updateIdentityNum(map);
		} else {
