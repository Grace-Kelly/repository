...
<mt-button icon="back" class="f20"></mt-button>
</router-link>
...
<main>
    ...
    <div class="personal-form">
                        ...
                        <div class="list-input">
                            <p class=" ">企业名称</p>
                            <input    placeholder="请填写" disabled v-model="this.$store.state.companyNo">
                        </div>
                          <div class="texthint mui-text-right mui-col-xs-12 f14" v-if="!personal.companyName">
                            企业名称不能为空
                          </div>
                        </div>
                        <div class="list-box">
                        <div class="list-input">
                            <p class=" ">营业执照编号</p>
                            <input  v-model="personal.licenseNum"  placeholder="请填写">
                        </div>
                          <div class="texthint mui-text-right mui-col-xs-12 f14" v-if="!personal.licenseNum">
                            营业执照编号不能为空
                          </div>
                        </div>
                      ...
                      <div class="list-box">
                        <div class="list-input">
                            <p class=" ">企业注册地址</p>
                            <input  v-model="personal.address"  placeholder="请填写">
                        </div>
                          <div class="texthint mui-text-right mui-col-xs-12 f14" v-if="!personal.address">
                            企业地址不能为空
                          </div>
                        </div> 
                       ...
                       <div class="list-input">
                            ...
                            <p class="verificationCode" style="border-left:transparent">选择上传</p>
                            <input class="verificationInput"   @change='add_img' placeholder="" type="file">
                        </div>
                          <!--<div class="texthint mui-text-right mui-col-xs-12 f14" v-if="!imgs">
                            企业执照不能为空
                          </div>-->
                        </div>
    ...
    $(".texthint").css("display","block");
          ...
          let enter=4;
                  ...
                  if(!enter){
                    console.log("成功")
                    Indicator.open();
this.personal.companyName=this.$store.state.companyNo
                    this.$http.post('/personCredit/companyAdmin/companyInfoAuth.do',this.personal)
                    .then((res)=>{
                    Indicator.close()
                    if(res.body.status=='ok'){

this.$store.commit("updateStatus_auth")        
let instance = Toast('认证通过');
setTimeout(() => {
instance.close();
}, 1000);
setTimeout(() => {
...
this.personal.licenseNum='';
this.personal.licenseImage=[];
