...
<div class="pagePersonal">
     <mt-header class="mint-header is-fixed" title="简历录入">
...
<main>
         <div class="mui-content bgc0">
              ...
              <credential class="showList" v-for="(index, item) in $store.state.educationList" ></credential> 
         </div>
</main>
